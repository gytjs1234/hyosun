...
<body>
						...
						<div class="row">				
							<div class="col-xs-12 col-sm-12 apply ">
								...
								<label class="control radio mt-3 mr-3">
									<input name="tel" type="radio" class="add-contrast" data-role="collar">
									<span class="control-indicator"></span><span class="control-text">연락처</span>
								</label>
								<label class="control radio mt-3">
									<input name="email" type="radio" class="add-contrast" data-role="collar">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input name="Rocal" type="email" class="form-control" id="inputRocal" placeholder="답변 받을 연락처를 입력해 주세요. ">
									</div>
								</div>
		...
		<div class="fixed-bottom">
			<div class="row no-gutters">
				<div class="col-12"><button type="submit" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#inputModal">문의하기</button></div>
			</div>
		</div>
		<!--// 하단버튼 -->
					</form>
			...
			<div class="modal-dialog modal-sm modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-footer-btm">
						<div class="row">							
							<div class="col-12"><a href="#none" class="btn btn-primary btn-lg btn-block" data-dismiss="modal">확인</a></div>
						</div>
					</div>
				</div>
			</div>
