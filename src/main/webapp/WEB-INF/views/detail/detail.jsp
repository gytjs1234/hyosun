...
<body>
	...
	<div class="container nopadding">
		<div class="card mt-3">
			...
			<div class="rateit-wrap">
				<span class="float-left">${COMMONDETAIL.addr1}</span> &nbsp;&nbsp;
			</div>
	...
	<div class="tab-content" id="nav-tabContent">
		...
		<div class="tab-pane fade" id="nav-talk" role="tabpanel"
			...
			<div class="container nopadding mt-3">
				...
				<div class="row-story-col top">
					...
					<div class="col">
						<strong>바다조아</strong> · <small class="grey">11분전</small><br />
			...
			<div class="tab_barwrap fixed-bottom">
				<div class="container nopadding">
					<form class="form-line" style="margin-top: 1px;">
						<div class="form-group row">
							<div class="col-10">
								<a href="story-add-photo" class="float-photo"> <img
									src="${rootPath}/static/img/svg/icon-photo.svg" alt="사진"
									class="icon-sm" />
								</a> <input type="email" class="form-control no-line ml-4"
									id="inputName" placeholder="댓글을 입력해주세요." value="">
							</div>
							<div class="col-2 text-right">
								<a class="btn btn-primary btn-sm-nav-tab" href="#none">등록</a>
							</div>
						</div>
					</form>
				</div>
		...
		<!-- Modal 메뉴더보기 -->
		<div class="modal fade" id="ellipsisModal" tabindex="-1" role="dialog"
			aria-labelledby="ellipsisModalLabel">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-sm modal-xs">
					<div class="modal-body">
						<div class="list-group">
							<a href="#" class="list-group-item" data-dismiss="modal">수정하기</a>
							<a href="#" class="list-group-item" data-dismiss="modal"
								data-toggle="modal" data-target="#delModal">삭제하기</a> <a href="#"
								class="list-group-item" data-dismiss="modal">닫기</a>
						</div>
					</div>
				</div>
			</div>
